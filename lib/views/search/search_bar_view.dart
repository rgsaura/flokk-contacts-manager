...
import 'package:flokk/views/search/search_bar.dart' as flokk_search;
...
class SearchBarView extends WidgetView<flokk_search.SearchBar, flokk_search.SearchBarState> {
  SearchBarView(flokk_search.SearchBarState state, {Key? key}) : super(state, key: key);
...
class _AnimatedSearchCard extends StatelessWidget {
  final Widget? child;
  final flokk_search.SearchBarState searchBar;
